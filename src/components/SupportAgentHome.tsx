...
export const SupportAgentHome = () => {
  return (
    <div className="flex flex-col items-center justify-center w-1/3 gap-14 text-main-white">
      ...
      >
        <SwiperSlide>
          <div className="bg-[radial-gradient(ellipse_60%_100%_at_90%_100%,var(--color-primary)_0%,var(--color-bg-secondary)_50%)] rounded-lg h-full gap-2 text-pretty text-center flex flex-col items-center justify-between p-5 border border-bg-secondary border-b-primary/50">
        ...
        <SwiperSlide>
          <div className="bg-[radial-gradient(ellipse_60%_100%_at_90%_100%,#4a29a5_0%,var(--color-bg-secondary)_50%)] rounded-lg h-full text-pretty text-center flex flex-col items-center justify-around p-5 border border-bg-secondary border-b-[#4a29a5]">
            <p>Una vez cargado tus datos te redigirá a la sección Resumen.</p>
            <p>Ahi podrás ver tus datos de una manera sencilla.</p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="bg-[radial-gradient(ellipse_60%_100%_at_90%_100%,#1278a0_0%,var(--color-bg-secondary)_50%)] rounded-lg h-full text-pretty text-center flex flex-col items-center justify-around p-5 border border-bg-secondary border-b-[#1278a0]">
            <p>Además, tenes la sección de Gráficos.</p>
            <p>Donde podrás ver tus datos de una forma visual.</p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className=" bg-[radial-gradient(ellipse_60%_100%_at_90%_100%,#a18b0e_0%,var(--color-bg-secondary)_50%)] rounded-lg h-full text-pretty text-center flex flex-col items-center justify-around p-5 border border-bg-secondary border-b-[#a18b0e]">
        ...
        <SwiperSlide>
          <div className="bg-[radial-gradient(ellipse_60%_100%_at_90%_100%,#ad434c_0%,var(--color-bg-secondary)_50%)] rounded-lg h-full text-pretty text-center flex flex-col items-center justify-around p-5 border border-bg-secondary border-b-[#ad434c]">
            <p>Y Listo!</p>
